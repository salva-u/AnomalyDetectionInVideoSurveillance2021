...
def load_dataset_One_Video_Features(Test_Video_Path):
    ...
    # we have already computed features for the whole video and divided the video features into 32 segments.
...
AllTest_Video_Path = './Dataset/TestingVMZFeatures/'
# AllTest_Video_Path contains features (txt file)  of each video. Each file contains 32 features, each of 2048 dimensions.
Results_Path = './EvalRes_VMZ/'
# Results_Path is the folder where you can save your results
Model_dir='./TrainedVMZAnomalyModel/'
# Model_dir is the folder where we have placed our trained weights
weights_path = Model_dir + 'VMZweightsAnomalyL1L2_20000.mat'
# weights_path is Trained model weights

model_path = Model_dir + 'def_run_model_VMZ.json'
