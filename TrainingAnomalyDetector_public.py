...
checkpoint_path = "./checkpointsVMZ"
...
for it_num in range(num_iters):
    ...
    if total_iterations % 1000 == 0:  # Save the model at every 1000th iterations.
       weights_path = output_dir + 'VMZweightsAnomalyL1L2_' + str(total_iterations) + '.mat'
